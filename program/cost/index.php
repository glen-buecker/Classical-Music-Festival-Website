...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
  ...
  <!-- Main Theme Stylesheet -->
	...
	<!-- Plugin injected code -->
		...
		<link rel='stylesheet' type='text/css' media='all' href='files/stacks_page_page13.css?rwcache=685984326' />
        <script type='text/javascript' charset='utf-8' src='https://ajax.googleapis.com/ajax/libs/jquery/2.2.4/jquery.min.js'></script>
        
        <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">
        
		
		<script type='text/javascript' charset='utf-8' src='files/stacks_page_page13.js?rwcache=685984326'></script>
...
//include_once "files/stacks_page_page13.php";
	...
	<nav class="navigation_bar clearfix  f-bg" role="navigation">
		<div class="container navigation_container">
			...
			<div class="logo_float_clear"></div>  <!-- Clears float on mobile devices -->
				...
				<ul><li><a href="../../" rel="" class="nav_item">Home</a></li><li><a href="../../about/" rel="" class="nav_item parent">About the Festival</a><ul><li><a href="../../about/overview/" rel="" class="nav_item">Overview</a></li><li><a href="../../about/personnel/" rel="" class="nav_item">Personnel</a></li><li><a href="../../about/links/" rel="" class="nav_item">Donate</a></li></ul></li><li class="Selected"><a href="../../program/" rel="" class="nav_item nav_active parent">Festival program</a><ul><li><a href="../../program/dates/" rel="" class="nav_item">Festival Dates and Travel</a></li><li><a href="../../program/repertoire/" rel="" class="nav_item">Repertoire</a></li><li><a href="../../program/schedule/" rel="" class="nav_item">Schedule</a></li><li><a href="../../program/registration/" rel="" class="nav_item">Registration</a></li><li class="Selected"><a href="./" rel="" class="nav_item nav_active">Cost</a></li></ul></li><li><a href="../../piano/" rel="" class="nav_item parent">Piano Seminar</a><ul><li><a href="../../piano/overview/" rel="" class="nav_item">Overview</a></li><li><a href="../../piano/description/" rel="" class="nav_item">Program Description</a></li><li><a href="../../piano/cost/" rel="" class="nav_item">Cost</a></li><li><a href="../../piano/registration/" rel="" class="nav_item">Registration</a></li><li><a href="../../piano/faculty/" rel="" class="nav_item">Piano Faculty and Presenters</a></li></ul></li><li><a href="../../accommodations/" rel="" class="nav_item">Accommodations</a></li><li><a href="../../trips/" rel="" class="nav_item">Optional Trips</a></li></ul>
...
if ( $setupIsComplete ) {
    ...
    $soloContent = displaySoloContent( $dbLink, '12', 'true', $armadilloOptions );
    ...
    if ( $soloContent == Armadillo_Language::public_msg($armadilloOptions, 'ARM_CONTENT_SELECTED_ITEM_MISSING') ) {
	    ...
	    if ( $soloContent['publish'] ) {
	    	$padding_for_12 = $soloContent['content'] == '' ? ' armadilloPadding' : '';
	    	echo '<div id="armadilloSoloContent_12_stacks_in_15" class="armadilloContent' . $padding_for_12 . '">' . $soloContent['content'] . '</div>';
	    } else {
	    	echo '<div id="armadilloSoloContent_12_stacks_in_15" class="armadilloContent draft"></div>';
    	}
    }
} else {
...
?>
	<!--<style>#armadilloSoloContent_12_stacks_in_15.draft { min-height: 2em; }</style>-->
	...
	<?php else: ?>
	<div class="armadilloEditButton"><a href="#editSoloContentID_12_stacks_in_15" class="displayEditor"><i class="fa fa-pencil-square-o"></i>&nbsp;ID: 12</a></div>
	<?php endif; ?>
	<div id="editSoloContentID_12_stacks_in_15" class="editSoloContent" style="display:none;">
		<div id="editSoloContentID_12_stacks_in_15_toolbar"></div>
        ...
        <!-- Rich Text Editor -->
        <textarea id="soloContentID_12_stacks_in_15" name="soloContentID_12_stacks_in_15"><?php echo htmlspecialchars($soloContent['content'], ENT_QUOTES, 'UTF-8'); ?></textarea>
        <?php else: ?>
        <!-- Markdown Editor -->
        <textarea autofocus id="soloContentID_12_stacks_in_15" name="soloContentID_12_stacks_in_15" data-uk-htmleditor="{markdown:true,autofocus:true}"><?php if ( isset($soloContent['format']) and $soloContent['format'] == 'markdown' ) { echo $soloContent['rawContent']; } ?></textarea>
        <?php if ( !isset($soloContent['format']) or $soloContent['format'] == 'html' ): ?>
        <script>document.addEventListener("DOMContentLoaded", function(event) { soloContentID_12_stacks_in_15 = document.getElementById('soloContentID_12_stacks_in_15'); soloContentID_12_stacks_in_15.value = toMarkdown('<?php echo str_replace(array("\n", "\r"),'', str_replace("'","\'",$soloContent['rawContent'])); ?>'); });</script>
        <?php endif; ?>
	    <?php endif; ?>
		<p class="saveSoloContentDetails">
			<a href="#soloContentID_12_stacks_in_15" id="saveSoloContentID_12_stacks_in_15" class="saveSoloContentButton armadilloButton"><?php echo Armadillo_Language::public_msg($armadilloOptions, 'ARM_SOLO_CONTENT_SAVE_TEXT'); ?></a>
	...
	<script>
		document.addEventListener("DOMContentLoaded", function(event) {
			var armadilloSoloContent_12_stacks_in_15 = {};
			armadilloSoloContent_12_stacks_in_15 = (function(){
				<?php if ( !isset($_COOKIE['armadillo']['editorType']) or ( isset($_COOKIE['armadillo']['editorType']) and ( $_COOKIE['armadillo']['editorType'] == 'richtext' or $_COOKIE['armadillo']['editorType'] == 'basictext' ) ) ): ?>
				$R('#soloContentID_12_stacks_in_15', {
					toolbarExternal: '#editSoloContentID_12_stacks_in_15_toolbar',
					toolbarFixed: true,
					autoresize: false,
					maxHeight: 500,
				...
				<?php endif; ?>
				armasolo.jQuery('#saveSoloContentID_12_stacks_in_15').click(function(){
					<?php if ( !isset($_COOKIE['armadillo']['editorType']) or ( isset($_COOKIE['armadillo']['editorType']) and ( $_COOKIE['armadillo']['editorType'] == 'richtext' or $_COOKIE['armadillo']['editorType'] == 'basictext' ) ) ): ?>
					var updatedContent = $R('#soloContentID_12_stacks_in_15', 'source.getCode');
					var previewHTML = updatedContent;
					updatedContent = encodeURIComponent(updatedContent);
					var format = 'html';
					<?php else: ?>
					var updatedContent = encodeURIComponent(armasolo.jQuery('#soloContentID_12_stacks_in_15').val());
					var previewHTML = armasolo.jQuery('#editSoloContentID_12_stacks_in_15 .uk-htmleditor .uk-htmleditor-content .uk-htmleditor-preview').html();
					var format = 'markdown';
					<?php endif; ?>
					armasolo.jQuery.ajax({
						beforeSend: function(){ armasolo.jQuery('#editSoloContentID_12_stacks_in_15 .saveSoloContent.result i.fa').removeClass('fa-times, fa-check').parent().css('opacity',0); armasolo.jQuery('#editSoloContentID_12_stacks_in_15 .saveSoloContent.progress').fadeTo(300,1); },
						url: '../../rw_common/plugins/stacks/armadillo/core/model/updateArmadilloSettings.php',
						type: 'post',
						data: 'action=updateContent&format=' + format + '&contentID=12&content=' + updatedContent,
						success: function(data, status) {
							if ( data == 'true' ) {
								armasolo.jQuery('#editSoloContentID_12_stacks_in_15 .saveSoloContent.result i.fa').addClass('fa-check').parent().fadeTo(300,1);
								armasolo.jQuery('#armadilloSoloContent_12_stacks_in_15').html(previewHTML);
							} else { console.log(data); console.log(status); armasolo.jQuery('#editSoloContentID_12_stacks_in_15 .saveSoloContent.result i.fa').addClass('fa-times').parent().fadeTo(300,1); }
						},
						error: function(jqxhr, status, error) { console.log(error); console.log(jqxhr); armasolo.jQuery('#editSoloContentID_12_stacks_in_15 .saveSoloContent.result i.fa').addClass('fa-times').parent().fadeTo(300,1); },
						complete: function(){ armasolo.jQuery('#editSoloContentID_12_stacks_in_15 .saveSoloContent.progress').fadeTo(300,0); }
					});
				});
			})(armadilloSoloContent_12_stacks_in_15);
		});
	</script>
<?php endif; ?>
</div>
